...
import { CalendarDays, MapPin, Clock, ArrowLeft, Minus, Plus } from "lucide-react";
...
const EventDetail = () => {
  ...
  const handleCheckout = () => {
    ...
    sessionStorage.setItem("checkout", JSON.stringify({ event, tickets: selected, total: totalPrice }));
    navigate("/checkout");
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 rounded-lg border border-border bg-card p-6 space-y-4">
              <h2 className="font-heading font-semibold text-lg">Select Tickets</h2>
